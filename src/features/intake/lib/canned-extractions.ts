...
const CANNED: Record<string, InvoiceExtraction> = {
  ...
  "wework-invoice.pdf": {
    ...
    lineItems: [
      {
        description: "Private office suite — May",
        amountCents: 600_000,
        type: "EXPENSE",
      },
      {
        description: "Conference room credits",
        amountCents: 100_000,
        type: "EXPENSE",
      },
      {
        description: "Parking (2 spots)",
        amountCents: 80_000,
        type: "EXPENSE",
      },
    ],
  ...
  "latham-invoice.pdf": {
    ...
    lineItems: [
      {
        description: "Legal counsel — Series B preparation (25 hrs)",
        amountCents: 1_000_000,
        type: "EXPENSE",
      },
      {
        description: "Filing and registration fees",
        amountCents: 150_000,
        type: "EXPENSE",
      },
      {
  ...
  "notion-invoice.pdf": {
    ...
    lineItems: [
      {
        description: "Notion Team Plan — 15 seats",
        amountCents: 45_000,
        type: "EXPENSE",
      },
      {
        description: "Notion AI add-on — 15 seats",
        amountCents: 44_000,
        type: "EXPENSE",
      },
    ],
